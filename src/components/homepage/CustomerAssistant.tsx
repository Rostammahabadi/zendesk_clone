  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end">
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="mb-4 bg-white dark:bg-gray-800 rounded-2xl shadow-lg overflow-hidden w-[400px]"
          >
            <div className="bg-blue-600 dark:bg-blue-700 p-4 text-white flex items-center gap-3">
      ...
      <button
        ...
        className="bg-blue-600 hover:bg-blue-700 text-white rounded-full p-4 shadow-lg transition-transform duration-200 hover:scale-110 flex items-center gap-2"
      >
